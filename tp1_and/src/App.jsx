...
//   return (<div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12 w-full">
//     <div className="relative py-3 sm:max-w-full sm:mx-auto w-full">
